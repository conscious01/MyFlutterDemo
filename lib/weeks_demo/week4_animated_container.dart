  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        Wrap(
          children: <Widget>[
            TextButton(onPressed: _changeColor, child: Text('改变颜色',style: TextStyle(color: Colors.white))),
            TextButton(onPressed: _changeSize, child: Text('改变大小',style: TextStyle(color: Colors.white))),
            TextButton(onPressed: _changeRadius, child: Text('改变形状',style: TextStyle(color: Colors.white))),
          ],
        )
      ],
    );
