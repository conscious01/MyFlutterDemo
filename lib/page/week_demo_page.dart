...
import '../controller/week_demo_controller.dart';

class WeekDemoPage extends GetView<WeekDemoController> {

  const WeekDemoPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('WeekDemoPage')),
      body: Padding(
